...
export const PLAYERS = [
  ...
  { id: 3, name: "R. Araujo",     pos: "CB",  rating: 87, age: 25, nat: "🇺🇾", value: 75000000, goals: 3,  assists: 1,  wage: 210000, contract: 2026, form: [9,8,7,9,8], x: 65, y: 72, stats: { pac: 82, sho: 50, pas: 65, dri: 70, def: 88, phy: 84 } },
  ...
  { id: 7, name: "F. de Jong",    pos: "DM",  rating: 87, age: 27, nat: "🇳🇱", value: 80000000, goals: 3,  assists: 4,  wage: 290000, contract: 2026, form: [8,7,8,9,8], x: 50, y: 58, stats: { pac: 80, sho: 69, pas: 86, dri: 87, def: 77, phy: 78 } },
  ...
  { id: 9, name: "Raphinha",      pos: "LW",  rating: 86, age: 27, nat: "🇧🇷", value: 60000000, goals: 18, assists: 10, wage: 200000, contract: 2027, form: [9,8,10,9,9], x: 20, y: 32, stats: { pac: 91, sho: 82, pas: 81, dri: 85, def: 52, phy: 73 } },
  ...
  { id: 11,name: "Lamine Yamal",  pos: "RW",  rating: 86, age: 16, nat: "🇪🇸", value: 120000000,goals: 12, assists: 8,  wage: 100000, contract: 2030, form: [9,9,9,9,9], x: 80, y: 32, image: "/players/lamine.png", stats: { pac: 92, sho: 83, pas: 82, dri: 91, def: 35, phy: 65 } },
];
